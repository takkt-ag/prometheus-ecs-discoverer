...
def test_extract_custom_labels_from_dockerlabels():
    ...
    assert discovery._extract_custom_labels_from_dockerlabels(
        dockerlabels, custom_labels_key="randomkey"
    ) == {"name": "value", "foo": "bar", "zoom": "fi"}
...
def test_extract_custom_labels_from_dockerlabels_custom():
    ...
    assert discovery._extract_custom_labels_from_dockerlabels(
        dockerlabels, custom_labels_key="randomkey", separator="+", equalizer="!"
    ) == {"name": "value", "foo": "bar", "zoom": "fi"}
...
def test_extract_custom_labels_from_dockerlabels_default():
    ...
    assert discovery._extract_custom_labels_from_dockerlabels(dockerlabels) == {
        "name": "value",
        "foo": "bar",
        "zoom": "fi",
    }
